...
<head>
    ...
    0">
    <title>Dhuye Dibo- Cart Details</title>
    <!-- bootstrap CSS link-->
...
if(!isset($_SESSION['username'])){
  echo "<li class='nav-item'>
  <a class='nav-link' href='./user/user_login.php'>Login</a></li>";
}else{
  echo "<li class='nav-item'>
  <a class='nav-link' href='./user/logout.php'>Logout</a></li>";
}
        ?>
        ...
        <div class="d-flex mb-5">
            <?php
             ...
             if($result_count>0){
                ...
                <button class='bg-secondary px-3 py-1 border-0'><a href='./user/checkout.php' class='text-light text-decoration-none'>
                Checkout</a></button>";
             }else{
